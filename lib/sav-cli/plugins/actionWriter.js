...
export function writeActions (dir, actions) {
  return ensureDir(dir).then(() => Promise.all(Object.keys(actions)
    .map((actionName) => writeAction(dir, actionName, actions[actionName])))
